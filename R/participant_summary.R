...
#'
#' @examples
#' summary <- snackapp::participant_summary(csv = TRUE)
participant_summary <- function(folder_path = file.path(getwd(), "data"), csv = FALSE, output_path = file.path(getwd(), "summary")) {
