...
#'
#' @return A dataframe that summarises the SnackApp usage data for each day a participant used the device.
#' @export
#'
#' @importFrom rlang .data

day_summary <- function(data, csv = FALSE, output_path = file.path(getwd(), "summary")) {
